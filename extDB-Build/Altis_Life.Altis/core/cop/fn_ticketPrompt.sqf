...
_control ctrlSetStructuredText parseText format["<t align='center'><t size='.8px'>%1 dio una multa de $%2",_cop getVariable["realname",name _cop],_val];
...
[] spawn
{
	...
	{
		[[0,format["%1 ha rechazado pagar la multa.",profileName]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
		[[0,format["%1 ha rechazado pagar la multa.",profileName]],"life_fnc_broadcast",east,false] spawn life_fnc_MP;
		[[1,format["%1 ha rechazado pagar la multa.",profileName]],"life_fnc_broadcast",life_ticket_cop,false] spawn life_fnc_MP;
	};
};