...
//BD
if ({_objet isKindOf _x && (player isKindOf "U_I_HeliPilotCoveralls" || player isKindOf "I_medic_F" || side player != civilian)} count R3F_LOG_CFG_objets_remorquables > 0) then
{
